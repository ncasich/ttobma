        ...
        <div class="collapse navbar-collapse" id="navbar-content">
            ...
            <ul class="navbar-nav ms-auto bg-main">
                <li class="nav-item dropdown dropstart">
                    <a class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Test User </a>
